...
export const serverStatus = pgTable("server_status", {
  ...
  dhcpRangeStart: text("dhcp_range_start").default("192.168.1.100"),
  dhcpRangeEnd: text("dhcp_range_end").default("192.168.1.200"),
  subnetMask: text("subnet_mask").default("255.255.255.0"),
  defaultGateway: text("default_gateway").default("192.168.1.1"),
  bootMode: text("boot_mode").default("bios"), // bios, uefi, uefi-secure
  bootTimeout: integer("boot_timeout").default(30),
  tlsEncryption: boolean("tls_encryption").default(true),
  macFiltering: boolean("mac_filtering").default(false),
